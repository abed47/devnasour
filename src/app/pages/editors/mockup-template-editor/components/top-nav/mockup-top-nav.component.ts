...
@Component({
  selector: 'mockup-top-nav',
  templateUrl: './mockup-top-nav.component.html',
  styleUrls: ['./mockup-top-nav.component.scss']
})
export class MockupTopNavComponent implements OnInit {
