...
import { MockupBgSelectDialogComponent } from './components/bg-select-dialog/mockup-bg-select-dialog.component';
...
export class MockupEditorComponent implements OnInit, OnDestroy, AfterViewChecked {
  ...
  private handleObjectUpdate(e){
    ...
    console.log(e); this.fab.getObjects().indexOf(this.selectedObject)
