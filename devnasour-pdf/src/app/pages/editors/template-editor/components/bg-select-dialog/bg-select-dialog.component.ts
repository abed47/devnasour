...
@Component({
  selector: 'editor-bg-select-dialog',
  templateUrl: './bg-select-dialog.component.html',
  styleUrls: ['./bg-select-dialog.component.scss']
})
export class BgSelectDialogComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<BgSelectDialogComponent>,
